...
ies.append({ "iei" : "", "value" : "Service request message identity", "type" : "Message type", "reference" : "9.7", "presence" : "M", "format" : "V", "length" : "1"})
ies.append({ "iei" : "", "value" : "ngKSI", "type" : "key set identifier", "reference" : "9.11.3.32", "presence" : "M", "format" : "V", "length" : "1/2"})
ies.append({ "iei" : "", "value" : "Service type", "type" : "Service type", "reference" : "9.11.3.50", "presence" : "M", "format" : "V", "length" : "1/2"})
