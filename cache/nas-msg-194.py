...
ies.append({ "iei" : "", "value" : "PDU SESSION ESTABLISHMENT ACCEPT message identity", "type" : "Message type", "reference" : "9.7", "presence" : "M", "format" : "V", "length" : "1"})
ies.append({ "iei" : "", "value" : "Selected PDU session type", "type" : "PDU session type", "reference" : "9.11.4.11", "presence" : "M", "format" : "V", "length" : "1/2"})
ies.append({ "iei" : "", "value" : "Selected SSC mode", "type" : "SSC mode", "reference" : "9.11.4.16", "presence" : "M", "format" : "V", "length" : "1/2"})
